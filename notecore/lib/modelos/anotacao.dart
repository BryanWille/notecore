...
class Anotacao {
  ...
  Anotacao(this.titulo, this.descricao, this.horaCriacao, this.hexCor,
      {this.idNota});
  ...
  @override
  String toString() {
    return "Anoptações => (titulo: $titulo, descricao: $descricao, hexCor: $hexCor, data: $horaCriacao, idNota: $idNota)";
  }
}
